...
class wpad_edit_comment_form{
	...
	function get_form_title(){
		...
		if( isset($data[$comment_id]) && is_array( $data[$comment_id] ) && !empty( $data[$comment_id] ) ){
			...
			<a class="page-title-action" href="<?php echo site_url();?>/wp-admin/admin.php?page=wpad_comment_form_edit&comment_id=<?php echo $new_id; ?>"><?php _e( 'Add New' , 'wpad' ); ?></a>
			<?php
			...
			<div class="wpuf-form-holder">
				...
				<div class="wpuf-form-rows required-field">
		            ...
		            <div class="wpuf-form-sub-fields">
		                <label>
		                	<input checked="checked" type="radio" value="yes" name="required_<?php echo $key; ?>0"><?php _e( "Yes" , 'wpad' ); ?>
		                </label>		           
		            </div>
		        </div>
		        ...
		        <div class="wpuf-form-rows wpad_label">
		            ...
		            <label><?php _e( "Field Label" , 'wpad' ); ?><span class="required"> *</span>
		            	<a tool_tip="<?php _e( "Enter a title of this field." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		        	</label>
		            <input type="text" class="" name="label_<?php echo $key; ?>" value="<?php _e( $label , 'wpad' ); ?>">
		        </div>
		        ...
		        <div class="wpuf-form-rows wpad_help_text">
		            ...
		            <label><?php _e( "Help Text" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Give the user some information about this field." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		        ...
		        <div class="wpuf-form-rows wpad_css_class_name">
		            ...
		            <label><?php _e( "CSS Class Name" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Add a CSS class name for this field." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		        ...
		        <div class="wpuf-form-rows wpad_placeholder">
		            ...
		            <label><?php _e( "PlaceHolder Text" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Text for HTML5 placeholder attribute." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		        ...
		        <div class="wpuf-form-rows wpad_error_message">
		            ...
		            <label><?php _e( "Error Message" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Add custom error message. Leave it blank to show default message." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		        ...
		        <div class="wpuf-form-rows wpad_size">
		            ...
		            <label><?php _e( "Size" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Size of this field." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		...
		<li class="post_title">
			...
			<div class="wpuf-form-holder">
				...
				<div class="wpuf-form-rows required-field">
		            ...
		            <div class="wpuf-form-sub-fields">
		                <label>
		                	<input checked="checked" type="radio" value="yes" name="required_<?php echo $key; ?>1"> <?php _e( "Yes" , 'wpad' ); ?> 
		                </label>
		            </div>
		        </div>
    	...
    	<li class="post_title">
			...
			<div class="wpuf-form-holder">
				...
				<div class="wpuf-form-rows required-field">
		            ...
		            <div class="wpuf-form-sub-fields">
		                <label>
		                	<input checked="checked" type="radio" value="yes" name="required_<?php echo $key; ?>"> <?php _e( "Yes" , 'wpad' ); ?> 
		                </label>		             
		            </div>
		        </div>
		        <!-- 
		        ...
		        <div class="wpuf-form-rows wpad_default_value">
		            ...
		            <label><?php _e( "Default Value" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Default value for this field." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		        ...
		        <div class="wpuf-form-rows wpad_rows">
		            ...
		            <label><?php _e( "Rows" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Number of rows in textarea." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		        ...
		        <div class="wpuf-form-rows wpad_columns">
		            ...
		            <label><?php _e( "Columns" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Number of columns in textarea." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		        ...
		        <div class="wpuf-form-rows wpad_editor">
		        	<label><?php _e( "Editor" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Choose an Editor." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		        	</label>
		        	<div class="wpuf-form-sub-fields">
		                <label><input checked="" type="radio" value="textarea" name="comment_editor"> <?php _e( "Textarea" , 'wpad' ); ?></label>
	...
	*/
	...
	function edit_comment_form_menu(){
		add_submenu_page( null, 'WP Advanced Comment Forms Edit', __( 'Edit Comment Form' , 'wpad' ), 'delete_others_pages', 'wpad_comment_form_edit', array($this, 'edit_comment_form'));
	}
		...
		<li class="post_title wpad_section_break">
			...
			<div class="wpuf-form-holder">
		        ...
		        <div class="wpuf-form-rows wpad_label">
		        	...
		        	?>
		            <label><?php _e( "Field Label" , 'wpad' ); ?><span class="required"> *</span>
		            	<a tool_tip="<?php _e( "Enter a title of this section." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		        	</label>
		            <input type="text" class="" name="label_<?php echo $key; ?>" value="<?php echo $label; ?>">
		        </div>
		        <!-- 
		        ...
		        <div class="wpuf-form-rows wpad_help_text">
		        	...
		        	?>
		            <label><?php _e( "Help Text" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Give the user some information about this section." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
		            <textarea class="" name="help_text_<?php echo $key; ?>"><?php echo $help_text; ?></textarea>
		        </div>
			</div>
			...
			<div class="wpuf-form-holder">
		        ...
		        <div class="wpuf-form-rows wpad_help_text">
		            ...
		            <label><?php _e( "HTML Codes" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "Paste Your Html Codes Here" , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
			...
			<div class="wpuf-form-holder">
		        ...
		        <div class="wpuf-form-rows wpad_meta_key">
		            ...
		            <?php _e( "Meta Key" , 'wpad' ); ?> <span class="required">*</span>
		            	<a tool_tip="<?php _e( "Name of the meta key this field will save to." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		        	</label>
		        ...
		        <div class="wpuf-form-rows wpad_preview_image">
		        	<label>
		        		<?php _e( "Preview" , 'wpad' ); ?>
		        		<a class="wpad_tooltip" tool_tip="<?php _e( "Show the user's selected image preview before uploading." , 'wpad' ); ?>">
		        			<span></span>
		        		</a>
		        	</label>
		        	<?php 
			...
			<div class="wpuf-form-holder">
		        ...
		        <div class="wpuf-form-rows wpad_show_only_admin">
		        	...
		        	<label>
		        		...
		        		<a tool_tip="<?php _e( "Tick if you want to show this field to admin only." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		        	</label>
		...
		<li class="post_title">
			...
			<div class="wpuf-form-holder">
		        ...
		        <div class="wpuf-form-rows wpad_editor">
		        	...
		        	<div class="wpuf-form-sub-fields">
		                <label><input checked="" type="radio" value="textarea" name="comment_editor_<?php echo $key; ?>"> <?php _e( "Textarea" , 'wpad' ); ?> </label>
		                <label><input disabled="" type="radio" value="wp_editor" name="comment_editor"><span class="required"> <?php _e( "WP Editor ( Only For Premium Members )" , 'wpad' ); ?> </span></label>
		            </div>
		        </div>
		        <!--  
			...
			<div class="wpuf-form-holder">
		        ...
		        <div class="wpuf-form-rows wpad_select_text">
		            ...
		            <label><?php _e( "Select Text" , 'wpad' ); ?>
		            	<a tool_tip="<?php _e( "First element of the select dropdown. Leave this empty if you don't want to show this field." , 'wpad' ); ?>" class="wpad_tooltip"><span></span></a>
		            </label>
	...
	*/
	...
	function wpad_comment_element(){
		...
		switch ( sanitize_text_field( $_POST['type'] ) ) {
			...
			case 'text':
				$this->text( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'textarea':
				$this->textarea( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'radio':
				$this->radio( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'checkbox':
				$this->checkbox( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'select':
				$this->select( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'email':
				$this->email( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'url':
				$this->url( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'multi_select':
				$this->multi_select( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'section_break':
				$this->section_break( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'html':
				$this->html( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
				break;
			case 'user_image':
				$this->user_image( $key , $custom_field , sanitize_text_field( $_POST['type'] ) );
			default:
				# code...
				break;
	...
	function display_woocommerce_message(){
		...
		if( $result == true && !class_exists( 'wpad_woocommerce' ) ){ ?>
			<div class="woocommerce_notice">
				<h3 class="hndle">
					<span><?php _e( 'WooCommerce Advanced Product Reviews Available' , 'wpad' ); ?></span>
				</h3>
				<p>
					It seems like you are using WooCommerce. WP Advance Comment works with the WooCommerce reviews. If you want you can buy an extension to enable comment forms on the WooCommerce products. Download for just $19. <a href="http://codecanyon.net/item/woocommerce-advanced-product-reviews/16078109?ref=ravishakya" class="button" target="blank">Click Here</a>
				</p>
			</div>
			<?php
		}
