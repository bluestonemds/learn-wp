...
<div class="wrap">
							...
							<div class="inside">
    							...
    							<div class="wpad_other_options">
	    							...
	    							<p class="description">
	    								<strong>--------------------------- Note ---------------------------</strong> 
	    								<br><br>
		    							1) To show the comment form <code>comment_form()</code> / <code>comments_template()</code> tag should be enabled on the .php file where the post will be displayed.
		    							<br><br>	    							
		    							
	    								2) If the comment form doesn't display on some pages then <code>comment_form()</code> / <code>comments_template()</code> tag is not used in that file.
	    							</p>
	    							<br>
    								<label>
    									<input type="radio" name="replace_comment_form" value="show_on_all" <?php echo checked( $comment_forms_on_posts , 'show_on_all' ); ?>>
    									<?php _e( 'Replace default wordpress comment form.' , 'wpad' ); ?>
    								</label>
    								<p class="description">
    								...
    								<br>
    								<label>
    									<input type="radio" name="replace_comment_form" value="enable_certain_pages" <?php echo checked( $comment_forms_on_posts , 'enable_certain_pages' ); ?>>
    									<?php _e( 'Choose Pages / Posts' , 'wpad' ); ?>
    								</label>
    								<p class="description">
    								...
    								<label>
    									<input type="radio" name="replace_comment_form" value="none" <?php echo checked( $comment_forms_on_posts , 'none' ); ?>><?php _e( 'None of above' , 'wpad' ); ?>
    								</label>
    							</div>
                    			...
                    			<div class="tab-content">
									...
									<div id="wpad-metabox-settings" style="display:none">
										<table class="form-table">
											...
											$comment_order_position = !empty( $option[$id]['other']['comment_order_position'] ) ? $option[$id]['other']['comment_order_position'] : 'above';

											$verified_customer_badge = !empty( $option[$id]['other']['verified_customer_badge'] ) ? $option[$id]['other']['verified_customer_badge'] : '';
											$verified_customer_review = !empty( $option[$id]['other']['verified_customer_review'] ) ? $option[$id]['other']['verified_customer_review'] : '';
											?>
											<tbody>
												
												<!-- 
												  	For WooCommerce Product Rating
												-->
												...
												if( class_exists( 'wpad_woocommerce' ) ){ ?>
													...
													<tr>
														<th>
															<?php _e( 'WooCommerce Product Rating' , 'wpad' ); ?>
														</th>
														<td>
															<label>
																<input type="checkbox" name="verified_customer_badge" value="enable" <?php checked( $verified_customer_badge , 'enable' ); ?>>
																<?php _e( 'Show "Verified Owner" label for customer reviews' , 'wpad' ); ?>
															</label>
															<br>
															<label>
																<input type="checkbox" name="verified_customer_review" value="enable" <?php checked( $verified_customer_review , 'enable' ); ?>>
																<?php _e( 'Only allow reviews from "Verified Owners"' , 'wpad' ); ?>
															</label>
															<p class="description"><?php _e( 'The above settings will only work for the WooCommerce Products.' ); ?></p>
														</td>
													</tr>
												...
												<!-- 
												  	Comment Listing Position
												-->
												<tr>
													<th>
														<?php _e( 'Comment Listing Position' , 'wpad' ); ?>
													</th>
													<td>
														<label>
															<input type="radio" name="comment_order_position" value="above" <?php checked( $comment_order_position, 'above' );?> > <?php _e( 'Above Comment Form' , 'wpad' ); ?>
														</label>
														<br>
														<label>
															<input type="radio" name="comment_order_position" value="below" <?php checked( $comment_order_position, 'below' );?> > <?php _e( 'Below Comment Form' , 'wpad' ); ?>
														</label>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														<p class="description">
															<?php _e( 'If enabled the user roles will be shown. eg. administrator, subscriber, author etc. To change the user roles background color. Go to WP Advanced Comment > Settings > Roles Tab and choose your colors.' , 'wpad' ); ?>
												...
												<tr>
													...
													<td>
														<label>
															...
															<?php _e( 'Comments must be automatically approved.' , 'wpad' ); ?>
														</label>   
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														<select name="pagination_per_page"> 
															<option value="" disabled=""><?php _e( 'No of comments' , 'wpad' ); ?></option>
											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<p class="description">
															<?php _e( 'Note : For multiple emails use comma separated email.' , 'wpad' ); ?>
														</p>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td>
														<label>
															...
															<p class="description">
																<?php _e( 'Note : If enabled, a checkbox will be visible to the users. If the user tick the checkbox then only the mail will be sent.' , 'wpad' ); ?>
															</p>
														</label>
													</td>
												</tr>
	...
	<div id="wpad_dialog" title="<?php _e( 'Something is Wrong' , 'wpad' ); ?>" style="display:none">
  		<p><?php _e( 'Meta keys should not be empty. Please correct them and try agian. <br>Thank you.' , 'wpad' ); ?></p>
	</div>
	<div id="wpad_dialog_label" title="<?php _e( 'Something is Wrong' , 'wpad' ); ?>" style="display:none">
  		<p><?php _e( 'Field Labels should not be empty. Please correct them and try agian. <br>Thank you.' , 'wpad' ); ?></p>
	</div>
	<div id="wpad_dialog_same_keys" title="<?php _e( 'Something is Wrong' , 'wpad' ); ?>" style="display:none">
