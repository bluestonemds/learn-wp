	...
	<form id="comments-form" method="get" action="">
		<div class="tablenav top">
			<div class="alignleft actions bulkactions">
				...
				<input type="button" value="<?php _e( 'Apply' , 'wpad' ); ?>" class="button action" id="bulk_action" name="">
			...
			<div class="alignleft actions">
				...
				<select name="comment_order" autocomplete="off">
					<option value="" selected=""><?php _e( 'Order' , 'wpad' ); ?></option>
				...
				<input type="button" value="<?php _e( 'Filter' , 'wpad' ); ?>" class="button" id="post-query-submit" name="filter_action">
			</div>
