...
function custom_field_user_image( selected , i ){
 ...
 jQuery(document).on( 'click' , '[name=save_comment]' , function(){
 	...
 	datas['other']['verified_customer_badge'] = stripHtmltags( jQuery('[name=verified_customer_badge]:checked').val() );
 	datas['other']['verified_customer_review'] = stripHtmltags( jQuery('[name=verified_customer_review]:checked').val() );

 	// Comment Form settings
 	datas['other']['comment_order_position'] = stripHtmltags( jQuery('[name=comment_order_position]:checked').val() );
